...
export function Suggestion() {
    ...
    useEffect(() => {
        fetch("https://api.github.com/users/LucasMigliorini65/followers")
        .then((response) => {
    ...
    return (
        ...
        <img src={"https://avatars.githubusercontent.com/u/110692154?v=4"}/>
        <div className="user-infos-suggestion">
                <div className="infos">
                    <span>lucas_migliorini65</span>
                    <p>Lucas Migliorini</p>
                </div>
